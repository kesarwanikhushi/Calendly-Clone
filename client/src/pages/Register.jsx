...
export default function Register() {
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center overflow-hidden bg-surface py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="absolute bottom-[-10%] left-[-10%] w-[50%] h-[50%] bg-indigo-500/20 blur-[150px] rounded-full pointer-events-none" />
      ...
      <div className="max-w-md w-full space-y-8 bg-white/70 backdrop-blur-xl border border-white/50 p-8 sm:p-10 rounded-2xl shadow-2xl relative z-10">
        <div>
          <div className="flex justify-center mb-6">
            <div className="w-14 h-14 bg-gradient-to-tr from-primary to-indigo-600 rounded-xl shadow-lg flex items-center justify-center transform -rotate-3 hover:-rotate-6 transition-transform">
          ...
          <p className="mt-3 text-center text-sm text-text-secondary">
            Get started with simpler scheduling
          </p>
        </div>
